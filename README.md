...
- Der Spurversatz der KI-Autos richtet sich nach der echten Fahrbahnbreite statt nach einem für jede Straße gleichen Festwert - auf schmalen Straßen bleibt entsprechend weniger Platz zum Ausweichen, ohne über den Fahrbahnrand hinauszufahren.
...
- KI-Autos biegen jetzt wirklich ab: Eine Fahrt wird über den Straßengraphen aus mehreren Straßen verkettet (Zufallsfahrt von Kante zu Kante, geradeaus wahrscheinlicher als Abbiegen, Hauptstraßen bevorzugt, Sackgassen gemieden) statt wie zuvor nur eine einzige zugewiesene Straße vor und zurück zu fahren. Im Median rund 795 m je Fahrt mit 4 Abbiegungen und 13 berührten Kreuzungen. Nachgewiesen über den Testschalter `-LaLaBergAbbiegeTest`, der im laufenden Spiel zählt, wie viele Autos zügige Richtungsänderungen vollziehen.
...
- Routen nutzen nur beidseitig befahrbare Kanten des Straßengraphen (574 der 8520 Kanten sind Einbahnstraßen, 11 von 146 km): Der Wegfolger fährt eine Route am Ende rückwärts wieder zurück, auf einer Einbahnstraße wäre das Geisterfahrt. Am Wendepunkt selbst dreht das Auto weiterhin auf der Stelle, statt zu wenden. Die längeren Routen strecken den Abstand zwischen zwei Wendepunkten aber von rund 45 s auf rund 100 s Fahrzeit.
